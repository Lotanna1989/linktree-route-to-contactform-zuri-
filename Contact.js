  ...
  return (
    ...
    overflow:"hidden"}}>
                    ...
                    <span className='start'>
                      ...
                      <div className='inpdiv1' style={{ width:"40%"}}>
                    <label style={{padding:"0", margin:"0", width:"100%"}} id='first_name'>Firstname </label>
                    ...
                    <label style={{padding:"0", margin:"0", width:"100%",}} {...register("lastname",{required: true})} id='last_name'>Lastname</label>
                    ...
                    {errors.firstname?.type === "required" && "lastname is required"} 
                    </div>
                    ...
                    border:" 1px solid #D0D5DD", backgroundColor:"blue"}} id="btn__submit" type="submit" className='sub'>
                            Send Message
                    </button>
